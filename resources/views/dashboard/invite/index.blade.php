    ...
    <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Send a single invite</h4></div>
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::select('role_id', [], null, ['placeholder'=>'Select', 'class'=>'form-control']) !!}
                  </div>
                  <div class="form-group">
                    {!! Form::label('department_id', 'Department:' ) !!}
                    {!! Form::select('department_id', [], null, ['placeholder'=>'Select', 'class'=>'form-control']) !!}
                  </div>
                  <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Bulk invite new users from CSV</h4></div>
                <div class="panel-body">
